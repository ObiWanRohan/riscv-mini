...
object Control {
  ...
  val map = Array(
    ...
    LB    -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_IMM, ImmSel.IMM_I, ALU_ADD   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_LB , WbSel.WB_MEM, Y, CSR.N, N),
    LH    -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_IMM, ImmSel.IMM_I, ALU_ADD   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_LH , WbSel.WB_MEM, Y, CSR.N, N),
    LW    -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_IMM, ImmSel.IMM_I, ALU_ADD   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_LW , WbSel.WB_MEM, Y, CSR.N, N),
    LBU   -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_IMM, ImmSel.IMM_I, ALU_ADD   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_LBU, WbSel.WB_MEM, Y, CSR.N, N),
    LHU   -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_IMM, ImmSel.IMM_I, ALU_ADD   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_LHU, WbSel.WB_MEM, Y, CSR.N, N),
    ...
    FENCEI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_XXX, ImmSel.IMM_X, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_ALU, N, CSR.N, N),
    CSRRW -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_XXX, ImmSel.IMM_X, ALU_COPY_A, BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.W, N),
    CSRRS -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_XXX, ImmSel.IMM_X, ALU_COPY_A, BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.S, N),
    CSRRC -> List(PCSel.PC_4  , ASel.A_RS1,  BSel.B_XXX, ImmSel.IMM_X, ALU_COPY_A, BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.C, N),
    CSRRWI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_IMM, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.W, N),
    CSRRSI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_IMM, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.S, N),
    CSRRCI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_IMM, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.C, N),
