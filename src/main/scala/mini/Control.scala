...
object Control {
  ...
  val map = Array(
    ...
    CSRRWI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_XXX, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.W, N),
    CSRRSI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_XXX, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.S, N),
    CSRRCI-> List(PCSel.PC_4  , ASel.A_XXX,  BSel.B_XXX, ImmSel.IMM_Z, ALU_XXX   , BrType.BR_XXX, Y, StType.ST_XXX, LdType.LD_XXX, WbSel.WB_CSR, Y, CSR.C, N),
